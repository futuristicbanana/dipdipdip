...
MY_CONSUMER_KEY = 'M5BlbtiTd1EQNeC52BxWGOvRW'
MY_CONSUMER_SECRET = 'wNIQ1vVzMJg9yjUpFjEAfaf1lkBGzd9G4Et7YYEyP22oFzRK3d'
MY_ACCESS_TOKEN_KEY = '1006290753805402112-jXxNmFuvunbcC2DsXlT1ZIIh2vEGYw'
MY_ACCESS_TOKEN_SECRET = '7ZsMd7ZZNAWK3GN3ARtACbPbmBLWO7Mtk1DMbM6zN0dda'
...
SOURCE_ACCOUNTS = ["AudreyKitching"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
TWITTER_SOURCE_ACCOUNTS = ["AudreyKitching"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "KaudreyItching"  # The name of the account you're tweeting to.
